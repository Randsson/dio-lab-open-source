...
> [!NOTE]   
> Por exemplo, a URL https://github.com/randsson/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`randsson`" para a contribuição no repositório `dio-lab-open-source`.
